...
var recipes: [RecipeModel] = [
    ...
    //Dishes
    RecipeModel(title: "Tajine poulet", price: 6.50,photo: "tajine", description: "Notre tajine au poulet parfumé aux épices du Maroc est fait avec amour par notre chef. Des légumes du jours ainsi que de belles pièces de poulet accompagneront votre repas.", recipCategory: .dish),
    ...
    RecipeModel(title: "Corne de gazelle", price: 4.50, photo: "gazelle", description: "La corne de gazelle est une pâtisserie du Maroc en forme de petits croissants dont le cœur moelleux contient de la pâte d'amande, de la canelle et de l'eau de fleur d'oranger.", recipCategory: .dessert)
]
